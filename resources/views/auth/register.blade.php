            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-4">
                   ...
                   class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('email')
                    ...
                    @error('email')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ 'Email обязателен и должен быть корректным. Например: mail@ya.ru' }}
                        </div>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password" id="password" placeholder="Придумайте пароль" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password') border-red-500 @enderror" value="">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Повторите пароль" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password_confirmation') border-red-500 @enderror" value="">
                ...
                <div>
                    ...
                    font-medium w-full">Зарегистрироваться</button>
                </div>
            </form>
        </div>
    </div>
